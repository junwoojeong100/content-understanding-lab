...
```bash
# 코드 가져오기(이미 받았다면 생략)
git clone https://github.com/junwoojeong100/content-understanding-lab.git
cd content-understanding-lab
...
az login
az account set --subscription "<구독 ID 또는 이름>"
git clone https://github.com/junwoojeong100/content-understanding-lab.git && cd content-understanding-lab
